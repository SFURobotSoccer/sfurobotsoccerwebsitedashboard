import { FiArrowUpRight, FiUser, FiUserPlus, FiUsers } from "react-icons/fi"
        ...
        <div>
          <div className="flex flex-col w-11/12 rounded-lg">
            ...
            <p className="plus-jakarta-sans-body text-black text-opacity-60 text-md leading-7 text-left flex gap-2">
              As a sponsor, your organization will play a crucial role in
              shaping the future of our club. Our sponsorship program is
              designed to create mutually beneficial relationships, where your
              support in resources, expertise, or funding directly contributes
              to groundbreaking robotics projects and the development of
              next-generation engineers. In return, your organization gains
              visibility among a talented pool of students, access to
              cutting-edge research and testing events, and association with a
              leading force in the field of robotics.
            </p>
